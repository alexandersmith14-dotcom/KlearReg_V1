...
.hero-kstack{display:inline-flex;flex-direction:column;align-items:center;
  gap:.04em;flex:none}
.hero-kstack svg{width:1em;height:.85em;overflow:visible}
...
<div class="herowrap">
  ...
  <div class="hero-inner">
    <div class="hero-titleblock">
      <p class="hero-word"><span class="hero-kstack"><svg viewBox="0 0 40 34" aria-hidden="true">
        ...
        </svg><span class="kr kr-k">K</span></span>lea<span class="kr kr-r">R</span>ance</p>
